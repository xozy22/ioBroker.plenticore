...
const battery_ids = [
	...
	"devices.local.battery.SoH",
	"devices.local.battery.FullChargeCap_E",
	"devices.local.battery.WorkCapacity",
	"devices.local.battery.BatManufacturer",
	"devices.local.battery.BatModel",
	"devices.local.battery.BatSerialNo",
	"devices.local.battery.BatVersionFW"
];

// Human readable texts for the numeric inverter operating state (Inverter:State).
// Best-effort mapping based on the KOSTAL community documentation; unknown codes fall back to "Unknown (n)".
const inverter_state_texts = {
	0: 'Off',
	1: 'Init',
	2: 'IsoMeas',
	3: 'GridCheck',
...
const payload_data = [
	{
		...
		"mappings": {
			...
			"LimitEvuRel": {
				id: "devices.local.LimitEvuRel",
				type: 'float'
			},
			"Bat2Grid_P": {
				id: "devices.local.Bat2Grid_P",
				type: 'float'
			},
			"Grid2Bat_P": {
				id: "devices.local.Grid2Bat_P",
				type: 'float'
			},
			"PV2Bat_P": {
				id: "devices.local.PV2Bat_P",
				type: 'float'
			},
			"Grid_P": {
				id: "devices.local.Grid_P",
				type: 'float'
			},
			"Grid_Q": {
				id: "devices.local.Grid_Q",
				type: 'float'
			},
			"Grid_S": {
				id: "devices.local.Grid_S",
				type: 'float'
			},
			"Grid_L1_I": {
				id: "devices.local.Grid_L1_I",
				type: 'float'
			},
			"Grid_L1_P": {
				id: "devices.local.Grid_L1_P",
				type: 'float'
			},
			"Grid_L2_I": {
				id: "devices.local.Grid_L2_I",
				type: 'float'
			},
			"Grid_L2_P": {
				id: "devices.local.Grid_L2_P",
				type: 'float'
			},
			"Grid_L3_I": {
				id: "devices.local.Grid_L3_I",
				type: 'float'
			},
			"Grid_L3_P": {
				id: "devices.local.Grid_L3_P",
				type: 'float'
			},
			"Iso_R": {
				id: "devices.local.Iso_R",
				type: 'float'
			},
			"DigitalOut": {
				id: "devices.local.DigitalOut",
				type: 'int'
			},
			"WorkTime": {
				id: "devices.local.WorkTime",
				type: 'int'
			}
		}
	},
	{
		...
		"mappings": {
			...
			"InvIn_P": {
				id: "devices.local.ac.InvIn_P",
				type: 'float'
			},
			"InvOut_P": {
				id: "devices.local.ac.InvOut_P",
				type: 'float'
			},
			"ResidualCDc_I": {
				id: "devices.local.ac.ResidualCDc_I",
				type: 'float'
			}
		}
	},
	{
		...
		"mappings": {
			...
			"SoH": {
				id: "devices.local.battery.SoH",
				type: 'int'
			},
			"FullChargeCap_E": {
				id: "devices.local.battery.FullChargeCap_E",
				type: 'float'
			},
			"WorkCapacity": {
				id: "devices.local.battery.WorkCapacity",
				type: 'float'
			},
			"BatManufacturer": {
				id: "devices.local.battery.BatManufacturer",
				type: 'int'
			},
			"BatModel": {
				id: "devices.local.battery.BatModel",
				type: 'int'
			},
			"BatSerialNo": {
				id: "devices.local.battery.BatSerialNo",
				type: 'int'
			},
			"BatVersionFW": {
				id: "devices.local.battery.BatVersionFW",
				type: 'int'
			}
		}
	},
	{
		...
		"mappings": {
			"CosPhi": {
				id: "devices.local.powermeter.CosPhi",
				type: 'float'
			},
			"Frequency": {
				id: "devices.local.powermeter.Frequency",
				type: 'float'
			},
			"Exp_E": {
				id: "devices.local.powermeter.Exp_E",
				type: 'float'
			},
			"Exp_EQ": {
				id: "devices.local.powermeter.Exp_EQ",
				type: 'float'
			},
			"Exp_ES": {
				id: "devices.local.powermeter.Exp_ES",
				type: 'float'
			},
			"Imp_E": {
				id: "devices.local.powermeter.Imp_E",
				type: 'float'
			},
			"Imp_EQ": {
				id: "devices.local.powermeter.Imp_EQ",
				type: 'float'
			},
			"Imp_ES": {
				id: "devices.local.powermeter.Imp_ES",
				type: 'float'
			},
			"L1_I": {
				id: "devices.local.powermeter.L1_I",
				type: 'float'
			},
			"L1_P": {
				id: "devices.local.powermeter.L1_P",
				type: 'float'
			},
			"L1_Q": {
				id: "devices.local.powermeter.L1_Q",
				type: 'float'
			},
			"L1_S": {
				id: "devices.local.powermeter.L1_S",
				type: 'float'
			},
			"L1_U": {
				id: "devices.local.powermeter.L1_U",
				type: 'float'
			},
			"L2_I": {
				id: "devices.local.powermeter.L2_I",
				type: 'float'
			},
			"L2_P": {
				id: "devices.local.powermeter.L2_P",
				type: 'float'
			},
			"L2_Q": {
				id: "devices.local.powermeter.L2_Q",
				type: 'float'
			},
			"L2_S": {
				id: "devices.local.powermeter.L2_S",
				type: 'float'
			},
			"L2_U": {
				id: "devices.local.powermeter.L2_U",
				type: 'float'
			},
			"L3_I": {
				id: "devices.local.powermeter.L3_I",
				type: 'float'
			},
			"L3_P": {
				id: "devices.local.powermeter.L3_P",
				type: 'float'
			},
			"L3_Q": {
				id: "devices.local.powermeter.L3_Q",
				type: 'float'
			},
			"L3_S": {
				id: "devices.local.powermeter.L3_S",
				type: 'float'
			},
			"L3_U": {
				id: "devices.local.powermeter.L3_U",
				type: 'float'
			},
			"P": {
				id: "devices.local.powermeter.P",
				type: 'float'
			},
			"Q": {
				id: "devices.local.powermeter.Q",
				type: 'float'
			},
			"S": {
				id: "devices.local.powermeter.S",
				type: 'float'
			}
		}
	},
	...
	},
	{
		...
		"mappings": {
			...
			"Statistic:EnergyDischarge:Day": {
				id: "scb.statistic.EnergyFlow.EnergyDischargeDay",
				type: 'float'
			},
			"Statistic:EnergyDischarge:Month": {
				id: "scb.statistic.EnergyFlow.EnergyDischargeMonth",
				type: 'float'
			},
			"Statistic:EnergyDischarge:Year": {
				id: "scb.statistic.EnergyFlow.EnergyDischargeYear",
				type: 'float'
			},
			"Statistic:EnergyDischarge:Total": {
				id: "scb.statistic.EnergyFlow.EnergyDischargeTotal",
				type: 'float'
			},
			"Statistic:EnergyChargeInvIn:Day": {
				id: "scb.statistic.EnergyFlow.EnergyChargeInvInDay",
				type: 'float'
			},
			"Statistic:EnergyChargeInvIn:Month": {
				id: "scb.statistic.EnergyFlow.EnergyChargeInvInMonth",
				type: 'float'
			},
			"Statistic:EnergyChargeInvIn:Year": {
				id: "scb.statistic.EnergyFlow.EnergyChargeInvInYear",
				type: 'float'
			},
			"Statistic:EnergyChargeInvIn:Total": {
				id: "scb.statistic.EnergyFlow.EnergyChargeInvInTotal",
				type: 'float'
			},
			"Statistic:EnergyHomeOwn:Total": {
				id: "scb.statistic.EnergyFlow.EnergyHomeOwnTotal",
				type: 'float'
			},
			"Statistic:EnergyPv1:Day": {
				id: "scb.statistic.EnergyFlow.EnergyPv1Day",
				type: 'float'
			},
			"Statistic:EnergyPv1:Month": {
				id: "scb.statistic.EnergyFlow.EnergyPv1Month",
				type: 'float'
			},
			"Statistic:EnergyPv1:Year": {
				id: "scb.statistic.EnergyFlow.EnergyPv1Year",
				type: 'float'
			},
			"Statistic:EnergyPv1:Total": {
				id: "scb.statistic.EnergyFlow.EnergyPv1Total",
				type: 'float'
			},
			"Statistic:EnergyPv2:Day": {
				id: "scb.statistic.EnergyFlow.EnergyPv2Day",
				type: 'float'
			},
			"Statistic:EnergyPv2:Month": {
				id: "scb.statistic.EnergyFlow.EnergyPv2Month",
				type: 'float'
			},
			"Statistic:EnergyPv2:Year": {
				id: "scb.statistic.EnergyFlow.EnergyPv2Year",
				type: 'float'
			},
			"Statistic:EnergyPv2:Total": {
				id: "scb.statistic.EnergyFlow.EnergyPv2Total",
				type: 'float'
			},
			"Statistic:EnergyPv3:Day": {
				id: "scb.statistic.EnergyFlow.EnergyPv3Day",
				type: 'float'
			},
			"Statistic:EnergyPv3:Month": {
				id: "scb.statistic.EnergyFlow.EnergyPv3Month",
				type: 'float'
			},
			"Statistic:EnergyPv3:Year": {
				id: "scb.statistic.EnergyFlow.EnergyPv3Year",
				type: 'float'
			},
			"Statistic:EnergyPv3:Total": {
				id: "scb.statistic.EnergyFlow.EnergyPv3Total",
				type: 'float'
			}
		}
	},
	{
		...
		"mappings": {
			...
			"System:Props:Battery": {
				id: "scb.system.Props.Battery",
				type: 'int'
			},
			"System:Props:BatOptions": {
				id: "scb.system.Props.BatOptions",
				type: 'int'
			},
			"System:Props:Pv": {
				id: "scb.system.Props.Pv",
				type: 'int'
			},
			"System:Props:HWversion": {
				id: "scb.system.Props.HWversion",
				type: 'int'
			},
			"System:Props:InverterGen": {
				id: "scb.system.Props.InverterGen",
				type: 'int'
			},
			"System:Props:ShadowMgmt": {
				id: "scb.system.Props.ShadowMgmt",
				type: 'int'
			}
		}
	},
	{
		...
		"mappings": {
			"Update:Status": {
				id: "scb.update.Status",
				type: 'int'
			},
			"Update:Progress": {
				id: "scb.update.Progress",
				type: 'int'
			},
			"Update:Version": {
				id: "scb.update.Version",
				type: 'int'
			},
			"Update:StatusTime": {
				id: "scb.update.StatusTime",
				type: 'timestamp'
			}
		}
	},
	{
		...
		"mappings": {
			...
			"Event:ActiveErrorCnt": {
				id: "scb.event.ActiveErrorCnt",
				type: 'int'
			},
			"Event:ActiveWarningCnt": {
				id: "scb.event.ActiveWarningCnt",
				type: 'int'
			},
			"Event:ActiveAckCnt": {
				id: "scb.event.ActiveAckCnt",
				type: 'int'
			},
			"Event:ActiveAckCode": {
				id: "scb.event.ActiveAckCode",
				type: 'int'
			}
		}
	}
		...
		if(json[j][dataname]) {
			for(let i in json[j][dataname]) {
				...
				if(mappings[setting.id]) {
					...
					if(objid === 'devices.local.inverter.State') {
						let stateText = inverter_state_texts[setting.value];
						if('undefined' === typeof stateText) {
							stateText = 'Unknown (' + setting.value + ')';
						}
						adapter.setState('devices.local.inverter.StateText', stateText, true);
					}
				} else {
...
function setObjects() {
	let channels = {
		...
		'scb.system': 'System',
		'scb.system.Props': 'System properties',
		'scb.update': 'Firmware update',
	...
	adapter.setObjectNotExists('devices.local.inverter.State', {
		...
		common: {
			name: 'Inverter state',
			desc: 'Numeric inverter operating state',
			type: 'number',
			role: 'value.info',
			unit: '',
			states: inverter_state_texts,
			read: true,
			write: false
		},
		native: {}
	...
	adapter.setObjectNotExists('devices.local.inverter.StateText', {
		type: 'state',
		common: {
			name: 'Inverter state (text)',
			desc: 'Human readable inverter operating state',
			type: 'string',
			role: 'text',
			read: true,
			write: false
	...
	/** Extended data points (added: powermeter/KSEM, grid values, battery health, system/update/event) */

	let extraStates = [
		// devices.local extended
		{ id: 'devices.local.LimitEvuRel', name: 'Actual power limit (EVU) relative', role: 'value', unit: '%' },
		{ id: 'devices.local.Bat2Grid_P', name: 'Power from battery to grid', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.Grid2Bat_P', name: 'Power from grid to battery', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.PV2Bat_P', name: 'Power from PV to battery', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.Grid_P', name: 'Grid power (+ import / - export)', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.Grid_Q', name: 'Grid reactive power', role: 'value.power', unit: 'var' },
		{ id: 'devices.local.Grid_S', name: 'Grid apparent power', role: 'value.power', unit: 'VA' },
		{ id: 'devices.local.Grid_L1_I', name: 'Grid phase 1 current', role: 'value.current', unit: 'A' },
		{ id: 'devices.local.Grid_L1_P', name: 'Grid phase 1 power', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.Grid_L2_I', name: 'Grid phase 2 current', role: 'value.current', unit: 'A' },
		{ id: 'devices.local.Grid_L2_P', name: 'Grid phase 2 power', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.Grid_L3_I', name: 'Grid phase 3 current', role: 'value.current', unit: 'A' },
		{ id: 'devices.local.Grid_L3_P', name: 'Grid phase 3 power', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.Iso_R', name: 'Insulation resistance', role: 'value', unit: 'Ohm' },
		{ id: 'devices.local.DigitalOut', name: 'Digital output state', role: 'value', unit: '' },
		{ id: 'devices.local.WorkTime', name: 'Inverter operating time', role: 'value.info', unit: 's' },
		// devices.local.ac extended
		{ id: 'devices.local.ac.InvIn_P', name: 'Inverter input power', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.ac.InvOut_P', name: 'Inverter output power', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.ac.ResidualCDc_I', name: 'Residual DC current', role: 'value.current', unit: 'A' },
		// battery health
		{ id: 'devices.local.battery.SoH', name: 'State of Health', role: 'value.info', unit: '%' },
		{ id: 'devices.local.battery.FullChargeCap_E', name: 'Full charge capacity', role: 'value.info', unit: 'Ah' },
		{ id: 'devices.local.battery.WorkCapacity', name: 'Usable work capacity', role: 'value.info', unit: 'Wh' },
		{ id: 'devices.local.battery.BatManufacturer', name: 'Battery manufacturer (code)', role: 'value.info', unit: '' },
		{ id: 'devices.local.battery.BatModel', name: 'Battery model (code)', role: 'value.info', unit: '' },
		{ id: 'devices.local.battery.BatSerialNo', name: 'Battery serial number', role: 'value.info', unit: '' },
		{ id: 'devices.local.battery.BatVersionFW', name: 'Battery firmware version', role: 'value.info', unit: '' },
		// powermeter (KSEM) totals
		{ id: 'devices.local.powermeter.P', name: 'Powermeter total power (+ import / - export)', role: 'value.power', unit: 'W' },
		{ id: 'devices.local.powermeter.Q', name: 'Powermeter reactive power', role: 'value.power', unit: 'var' },
		{ id: 'devices.local.powermeter.S', name: 'Powermeter apparent power', role: 'value.power', unit: 'VA' },
		{ id: 'devices.local.powermeter.CosPhi', name: 'Powermeter CosPhi', role: 'value.info', unit: '' },
		{ id: 'devices.local.powermeter.Frequency', name: 'Powermeter grid frequency', role: 'value.info', unit: 'Hz' },
		{ id: 'devices.local.powermeter.Exp_E', name: 'Exported active energy', role: 'value.power.consumption', unit: 'Wh' },
		{ id: 'devices.local.powermeter.Exp_EQ', name: 'Exported reactive energy', role: 'value', unit: 'varh' },
		{ id: 'devices.local.powermeter.Exp_ES', name: 'Exported apparent energy', role: 'value', unit: 'VAh' },
		{ id: 'devices.local.powermeter.Imp_E', name: 'Imported active energy', role: 'value.power.consumption', unit: 'Wh' },
		{ id: 'devices.local.powermeter.Imp_EQ', name: 'Imported reactive energy', role: 'value', unit: 'varh' },
		{ id: 'devices.local.powermeter.Imp_ES', name: 'Imported apparent energy', role: 'value', unit: 'VAh' },
		// scb.system
		{ id: 'scb.system.State', name: 'System state', role: 'value.info', unit: '' },
		{ id: 'scb.system.Props.Battery', name: 'System property: battery', role: 'value.info', unit: '' },
		{ id: 'scb.system.Props.BatOptions', name: 'System property: battery options', role: 'value.info', unit: '' },
		{ id: 'scb.system.Props.Pv', name: 'System property: PV', role: 'value.info', unit: '' },
		{ id: 'scb.system.Props.HWversion', name: 'System property: hardware version', role: 'value.info', unit: '' },
		{ id: 'scb.system.Props.InverterGen', name: 'System property: inverter generation', role: 'value.info', unit: '' },
		{ id: 'scb.system.Props.ShadowMgmt', name: 'System property: shadow management', role: 'value.info', unit: '' },
		// scb.update
		{ id: 'scb.update.Status', name: 'Update status', role: 'value.info', unit: '' },
		{ id: 'scb.update.Progress', name: 'Update progress', role: 'value.info', unit: '%' },
		{ id: 'scb.update.Version', name: 'Update version', role: 'value.info', unit: '' },
		{ id: 'scb.update.StatusTime', name: 'Update status time', role: 'date', unit: '' },
		// scb.event
		{ id: 'scb.event.ErrMc', name: 'Error MC', role: 'value.info', unit: '' },
		{ id: 'scb.event.ErrSFH', name: 'Error SFH', role: 'value.info', unit: '' },
		{ id: 'scb.event.ActiveErrorCnt', name: 'Active error count', role: 'value.info', unit: '' },
		{ id: 'scb.event.ActiveWarningCnt', name: 'Active warning count', role: 'value.info', unit: '' },
		{ id: 'scb.event.ActiveAckCnt', name: 'Active acknowledge count', role: 'value.info', unit: '' },
		{ id: 'scb.event.ActiveAckCode', name: 'Active acknowledge code', role: 'value.info', unit: '' }
	];

	// powermeter (KSEM) per-phase states
	for(let ph = 1; ph <= 3; ph++) {
		extraStates.push({ id: 'devices.local.powermeter.L' + ph + '_I', name: 'Powermeter phase ' + ph + ' current', role: 'value.current', unit: 'A' });
		extraStates.push({ id: 'devices.local.powermeter.L' + ph + '_U', name: 'Powermeter phase ' + ph + ' voltage', role: 'value.voltage', unit: 'V' });
		extraStates.push({ id: 'devices.local.powermeter.L' + ph + '_P', name: 'Powermeter phase ' + ph + ' power', role: 'value.power', unit: 'W' });
		extraStates.push({ id: 'devices.local.powermeter.L' + ph + '_Q', name: 'Powermeter phase ' + ph + ' reactive power', role: 'value.power', unit: 'var' });
		extraStates.push({ id: 'devices.local.powermeter.L' + ph + '_S', name: 'Powermeter phase ' + ph + ' apparent power', role: 'value.power', unit: 'VA' });
	}

	for(let s = 0; s < extraStates.length; s++) {
		let ns = extraStates[s];
		adapter.setObjectNotExists(ns.id, {
			type: 'state',
			common: {
				name: ns.name,
				type: 'number',
	...
	for(let p = 0; p < periods.length; p++) {
		...
		statsStates.push({
			id: 'scb.statistic.EnergyFlow.EnergyDischarge' + periodId,
			name: 'Total battery discharge at current ' + period,
			role: 'value.power.consumption',
			unit: 'Wh'
		});

		statsStates.push({
			id: 'scb.statistic.EnergyFlow.EnergyChargeInvIn' + periodId,
			name: 'Battery charge from inverter input at current ' + period,
			role: 'value.power.consumption',
			unit: 'Wh'
		});

		statsStates.push({
			id: 'scb.statistic.EnergyFlow.EnergyPv1' + periodId,
			name: 'Energy yield PV string 1 at current ' + period,
			role: 'value.power.consumption',
			unit: 'Wh'
		});

		statsStates.push({
			id: 'scb.statistic.EnergyFlow.EnergyPv2' + periodId,
			name: 'Energy yield PV string 2 at current ' + period,
			role: 'value.power.consumption',
			unit: 'Wh'
		});

		statsStates.push({
			id: 'scb.statistic.EnergyFlow.EnergyPv3' + periodId,
			name: 'Energy yield PV string 3 at current ' + period,
			role: 'value.power.consumption',
			unit: 'Wh'
		});
	}
	...
	statsStates.push({
		id: 'scb.statistic.EnergyFlow.EnergyHomeOwnTotal',
		name: 'Total home consumption from own production',
		role: 'value.power.consumption',
		unit: 'Wh'
	});
